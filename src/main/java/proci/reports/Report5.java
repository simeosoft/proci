 ...
 * @author  simeo
 */
public class Report5 extends javax.swing.JInternalFrame 
        implements ChangeListener, IFormListener, ProciInternalFrame {

    private Map<String,Object> parameters = new HashMap<String,Object>();
    private JRViewer jw = null;
    private String REPORT_NAME = "RDatiSoci2.jasper";
    FormController fc;
    ...
    public Report5() {
        ...
        cbm = new ComboSociModel(conn, ETipoSocio.OPERATIVO);
        ...
        parameters.put("TITOLO","Report Dati Soci Operativi (per dati)");
    }
    ...
    public void eseguiReport() {
        ...
        String stipo = ((String) jcTipo.getSelectedItem()).substring(0,6);
        ...
        final DatiSociDataSource2 ds = new DatiSociDataSource2(conn,start_socio,end_socio,stipo);
        jbEsegui.setEnabled(false);
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Dati Soci Operativi (per dati)");
        ...
        jcTipo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "tutti i tipi", "solo dotazioni", "solo interventi", "solo esercitazioni", "solo specializzazioni", "solo dotazioni" }));
        gridBagConstraints = new java.awt.GridBagConstraints();
