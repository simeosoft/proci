 ...
 * @author  simeo
 */
public class Report4 extends javax.swing.JInternalFrame 
        implements ChangeListener, IFormListener, ProciInternalFrame {

    private Map<String,Object> parameters = new HashMap<String,Object>();
    private JRViewer jw = null;
    private String REPORT_NAME = "RDatiSoci.jasper";
    FormController fc;
    ...
    public Report4() {
        ...
        parameters.put("TITOLO","Report Dati Soci Operativi (per socio)");
    }
    ...
    public void eseguiReport() {
        ...
        final DatiSociDataSource ds = new DatiSociDataSource(conn,start_socio,end_socio);
        jbEsegui.setEnabled(false);
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Dati Soci Operativi (per socio)");
